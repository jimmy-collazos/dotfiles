# [Cătălin](https://github.com/jimmy-collazos)’s dotfiles [![Build Status](https://travis-ci.org/jimmy-collazos/dotfiles.svg?branch=master)](https://travis-ci.org/jimmy-collazos/dotfiles)
...
| OS | Snippet |
|:---|:---|
| `macOS` | `bash -c "$(curl -LsS https://raw.github.com/jimmy-collazos/dotfiles/master/src/os/setup.sh)"` |
| `Ubuntu` | `bash -c "$(wget -qO - https://raw.github.com/jimmy-collazos/dotfiles/master/src/os/setup.sh)"` |
...
[user]
    ...
    name = Jimmy Collazos
    email = jimmy-collazos@example.com
    signingkey = XXXXXXXX
```
...
`setup` script](https://github.com/jimmy-collazos/dotfiles/blob/1503cf23ef23f6e31342b140bcd246625160b94f/src/os/setup.sh#L3).
